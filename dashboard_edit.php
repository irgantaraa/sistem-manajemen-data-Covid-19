        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-dark p-0" id="content">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="dashboard.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Covid 19</h3></div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Covid19</p>
                        </div>
                         <div class="card-body">
                                <?php
                                ...
                                include "koneksi.php";
                                $id = $_GET['id'];
                                $query = mysqli_query($connect, "select * from indonesia where id_covid='$id'") or die(mysqli_error($connect));

                                while ($plg = mysqli_fetch_array($query)) {
                                    $ID_Covid = $plg['id_covid'];
                                    $lokasi = $plg['lokasi'];
                                    $terkonfirmasi = $plg['confirmed'];
                                    $sembuh = $plg['recovery'];
                                    $meninggal = $plg['death'];
                                }
                                ?>
                                <form method="POST" action="dashboard_edit_aksi.php">
                                    <div class="form-group">
                                        <label>
                                            <strong>Lokasi</strong>
                                            <br>
                                        </label>
                                        <input value="<?php echo $lokasi; ?>" class="form-control" type="text" name="lokasi">
                                    </div>
                                        <label>
                                            <strong>Terkonfirmasi</strong>
                                            <br>
                                        </label>
                                        <input value="<?php echo $terkonfirmasi; ?>" class="form-control" type="text" name="terkonfirmasi">
                                    </div>
                                     <div class="form-group">
                                        <label>
                                        ...
                                        <input value="<?php echo $sembuh; ?>" class="form-control" type="text" name="sembuh">
                                    </div>
                                     <div class="form-group">
                                        <label>
                                        ...
                                        <input value="<?php echo $meninggal; ?>" class="form-control" type="text" name="meninggal">
                                    </div>
